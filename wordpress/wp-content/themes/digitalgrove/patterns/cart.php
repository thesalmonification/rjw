...
<h2 class="wp-block-heading has-large-font-size"><?php echo esc_html__( 'You may be interested in…', 'digitalgrove' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center with-empty-cart-icon wc-block-cart__empty-cart__title"><?php echo esc_html__( 'Your cart is currently empty!', 'digitalgrove' ); ?></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'New in store', 'digitalgrove' ); ?></h2>
<!-- /wp:heading -->
