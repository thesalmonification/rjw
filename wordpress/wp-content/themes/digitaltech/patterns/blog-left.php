...
<h1 class="wp-block-heading has-text-align-center has-white-color has-text-color has-link-color" style="font-size:32px"><?php echo esc_html__( 'News Left Sidebar', 'digitaltech' ); ?></h1>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->
...
<div class="wp-block-column" style="padding-left:0;flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar"} /--></div>
<!-- /wp:column -->

<!-- wp:column {"width":"66.66%","style":{"spacing":{"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"backgroundColor":"white-text-color"} -->
