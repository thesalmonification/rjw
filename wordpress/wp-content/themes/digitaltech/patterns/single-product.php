<?php
  ...
  * Slug: digitaltech/single-product
  * Inserter: no
  */
?>
...
<div class="wp-block-cover" style="margin-top:0;margin-bottom:0;min-height:300px"><span aria-hidden="true" class="wp-block-cover__background has-secondary-background-color has-background-dim-100 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:post-title {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"32px"}}} /-->
...
<!-- wp:group {"tagName":"main","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"100px","bottom":"100px","left":"20px","right":"20px"}}},"fontSize":"small","layout":{"inherit":true,"type":"constrained"}} -->
<main class="wp-block-group has-small-font-size" style="margin-top:0;margin-bottom:0;padding-top:100px;padding-right:20px;padding-bottom:100px;padding-left:20px"><!-- wp:woocommerce/store-notices /-->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php echo esc_html__( 'Related Products', 'digitaltech' ); ?></h2>
<!-- /wp:heading -->
